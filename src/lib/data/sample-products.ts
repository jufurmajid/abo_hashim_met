...
export const CATEGORIES: Category[] = [
  { id: 'meats', name: 'اللحوم', slug: 'meats', description: 'لحوم بلدية طازجة عالية الجودة' },
  { id: 'dairy', name: 'الألبان', slug: 'dairy', description: 'ألبان طازجة وقشطة بلدية' },
  { id: 'cheese', name: 'الأجبان', slug: 'cheese', description: 'أجبان متنوعة ولذيذة' },
  { id: 'other', name: 'أخرى', slug: 'other', description: 'منتجات غذائية مكملة ومختارة' },
];
...
export const SAMPLE_PRODUCTS: Product[] = [
  {
    ...
    description: 'لحم خروف بلدي طازج ممتازة مقطع حسب الطلب، خالي من الدهون الزائدة.',
    price: 18000,
    unit: 'كغم',
    category: 'meats',
